...
with sv.VideoSink(output_video, video_info) as sink:
    for frame in sv.get_video_frames_generator(SOURCE_VIDEO):
        #cap_img_oreginal = cv.VideoCapture("rtsp://admin2:Aa1234567890@10.128.51.230/streaming/channels/101")
        #rect2, frame = cap_img_oreginal.read()
        ...
        #print('detection.xyxy[0] :', detection.xyxy[0])
        #imshow(frame)
        
        
        frame = trace_annotator.annotate(frame, detection)  # type: ignore
        
        #print('detection.confidence[0]', detection.confidence[0])
        ...
        print('labela', labels)
        #print('current_spedd', current_speed)
...
Video(compressed, width=960, height=560)
